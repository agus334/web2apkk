...
// Fix: Mencegah browser refresh saat scroll dari bawah ke atas
(function preventPullToRefresh() {
    ...
    document.addEventListener('touchmove', (e) => {
        ...
        // Deteksi arah scroll: positif = scroll ke atas (swipe down)
        const isScrollingUp = deltaY > 0;

        // Cek apakah halaman sudah di posisi paling atas
        const scrollTop = document.documentElement.scrollTop || document.body.scrollTop || window.scrollY;

        // Jika scroll ke atas (swipe down) dan sudah di atas halaman, prevent default
